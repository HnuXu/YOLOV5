...
parser.add_argument("--images_num", type=int, default=20000)
parser.add_argument("--image_size", type=int, default=640)
parser.add_argument("--images_path", type=str, default="/root/yolo/data/images/")
parser.add_argument("--labels_txt", type=str, default="/root/yolo/data/labels.txt")
...
image_paths  = [os.path.join(os.path.realpath("."), "/root/yolo/mnist/mnist/train/" + image_name) for image_name in os.listdir("/root/yolo/mnist/mnist/train/")]
image_paths += [os.path.join(os.path.realpath("."), "/root/yolo/mnist/mnist/test/"  + image_name) for image_name in os.listdir("/root/yolo/mnist/mnist/test/")]
