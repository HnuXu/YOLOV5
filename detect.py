...
def parse_opt():
    ...
    #parser.add_argument('--source', type=str, default=ROOT / 'data/Samples', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT / 'data/writenum.yaml', help='(optional) dataset.yaml path')
